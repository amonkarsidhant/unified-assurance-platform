...
- See: `artifacts/latest/promotion-decision.json` (generated by `make promotion-check`)
- Example output: [demo-broken-report.md](../assets/screenshots/demo-broken-output.md) shows NO-GO decision

*Promotion gate decision now captured via demo output.*
