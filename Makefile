...
# Quality & formatting
.PHONY: fmt lint lint-markdown lint-yaml lint-shell lint-links

# Core lifecycle
.PHONY: all clean bootstrap validate tooling-check test ci-local
...
# Resilience & chaos
.PHONY: resilience-intelligence resilience-intelligence-check resilience-adapter-check resilience-report
.PHONY: resilience-incident-trigger resilience-scorecard resilience-trend-export resilience-schedule-help
.PHONY: chaos-check chaos-sample zap-smoke phase-a-checks gitleaks-check schemathesis-check hadolint-check checkov-check
...
lint: lint-markdown lint-yaml lint-shell lint-links
	@echo "Lint complete."
